...
def function5():
    ...
    z = np.zeros((1,4,5)).astype(int)#wrtie your code here
...
def function6():
    ...
    arr = np.zeros(10).astype(int)#wrtie your code here
    arr[4]=10
    arr[7]=20
...
def function7():
    ...
    x = np.full((1,4), 0, dtype=np.int64)
...
return  np.where((arr %5==0) | (arr%3==0),"YES","NO")
    # Write Your Code HERE
...
def function19():
    ...
    W =  np.copy(X)
    W = W.transpose()# Write your code here 
